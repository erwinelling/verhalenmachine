...
David:
* Fix vumeter stuff for player => Analoog
* Fix volumemeter and vumeter stuff at same time (serial, so prob also kiku) => Analoog
* Add kiku => obv seriële data
* Improve audio player quality => Audioshield
